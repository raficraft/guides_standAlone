...
var $08a7d5afccd80df8$export$871b5a9be678db21 = function (args) {
  ...
  var ref = $iwYpZ$swchelpers.objectSpread({}, args),
    el = ref.el,
    action = ref.action,
    css = ref.css,
    _preventDefault = ref.preventDefault,
    preventDefault = _preventDefault === void 0 ? true : _preventDefault,
    next = ref.next;
  var fired = "";
  var reset = "";
...
var $f3f86e883dc3cb37$export$4b08aed5f1ec6952 = /*#__PURE__*/ (function () {
  ...
  function $f3f86e883dc3cb37$export$4b08aed5f1ec6952() {
    $iwYpZ$swchelpers.classCallCheck(
      this,
      $f3f86e883dc3cb37$export$4b08aed5f1ec6952
    );
  ...
  $iwYpZ$swchelpers.createClass($f3f86e883dc3cb37$export$4b08aed5f1ec6952, [
    {
      ...
      value: function UI_body() {
        ...
        this.UI = $08a7d5afccd80df8$export$adc6d72e517d4e6a(
          '<section id="UI_body" class="'.concat(
            $553c72c17236c2cd$export$c8e8069ed9c86e3d,
            '"></section>'
          )
        );
    ...
    return $08a7d5afccd80df8$export$f8777a72970d840a({
      background:
        "linear-gradient(to bottom,\n        transparent 3px,\n        "
          .concat(color, " 3px,\n        ")
          .concat(color, " ")
          .concat(parseInt(thickness) + 3, "px,\n        transparent ")
          .concat(parseInt(thickness) + 3, "px ,\n        transparent ")
          .concat(parseInt(thickness) + 5, "px\n        )"),
...
var $baf7081dc7041035$export$6dbaf1fff660fe95 = /*#__PURE__*/ (function () {
  ...
  function $baf7081dc7041035$export$6dbaf1fff660fe95() {
    $iwYpZ$swchelpers.classCallCheck(
      this,
      $baf7081dc7041035$export$6dbaf1fff660fe95
    );
    this.dragPosition = {
      start: {
        x: 0,
...
var $1e812745baee1e97$export$69e780ca9f7a6d74 = /*#__PURE__*/ (function () {
  ...
  function $1e812745baee1e97$export$69e780ca9f7a6d74() {
    $iwYpZ$swchelpers.classCallCheck(
      this,
      $1e812745baee1e97$export$69e780ca9f7a6d74
    );
  ...
  $iwYpZ$swchelpers.createClass($1e812745baee1e97$export$69e780ca9f7a6d74, [
    {
      ...
      value: function get_guides(e, direction, color, thickness) {
        ...
        !document.querySelectorAll('[data-type="guides"]').length
          ? (nbGuides = 0)
          : (nbGuides = document.querySelectorAll(
              '[data-type="guides"]'
            ).length);
        var offsetBy = "";
        var position = 0;
        ...
        direction === "X"
          ? (stylesSpan_Axis =
              $069ff03ea42df4f6$export$bcbbd831497ce88.span_axis_X(
                e.pageY,
                color,
                1
              ))
          : (stylesSpan_Axis =
              $069ff03ea42df4f6$export$bcbbd831497ce88.span_axis_Y(
                e.pageX,
                color,
                1
              ));
        var el_STRING = '<span\n        class="'
          .concat(
            $93509171e9f96b5d$export$6bd0430c083ef3cf,
            '"\n        style="'
          )
          .concat(
            stylesSpan_Axis,
    ...
    },
    {
      ...
      value: function addTerminal(item, color) {
        ...
        if (axis === "X") {
          styles_PseudoEl_Axis.before =
            $069ff03ea42df4f6$export$bcbbd831497ce88.span_pseudoEl_X_before(
              color
            );
          styles_PseudoEl_Axis.after =
            $069ff03ea42df4f6$export$bcbbd831497ce88.span_pseudoEl_X_after(
              color
            );
        } else {
          styles_PseudoEl_Axis.before =
            $069ff03ea42df4f6$export$bcbbd831497ce88.span_pseudoEl_Y_before(
              color
            );
          styles_PseudoEl_Axis.after =
            $069ff03ea42df4f6$export$bcbbd831497ce88.span_pseudoEl_Y_after(
              color
            );
        }
        var pseudoEl = {
          before: $08a7d5afccd80df8$export$adc6d72e517d4e6a(
            '<span\n          class="'
              .concat(
                $93509171e9f96b5d$export$80cd3f47130f5b35,
                '"\n          data-type="terminal" \n          data-direction="'
              )
              .concat(axis, '" \n          data-el="before"\n          style="')
              .concat(styles_PseudoEl_Axis.before, '">\n        </span>')
          ),
          after: $08a7d5afccd80df8$export$adc6d72e517d4e6a(
            '<span \n          class="'
              .concat(
                $93509171e9f96b5d$export$80cd3f47130f5b35,
                '"\n          data-type="terminal"\n          data-direction="'
              ...
              .concat(axis, '"\n          data-el="after"\n          style="')
              .concat(styles_PseudoEl_Axis.after, '">\n        </span>')
          ),
        };
        return pseudoEl;
      },
    },
    {
      ...
      value: function get_contextMenu(e1) {
        ...
        var X =
          e1.pageX > window.innerWidth - 100
            ? "".concat(e1.pageX - 150, "px")
            : "".concat(e1.pageX, "px");
        var Y =
          e1.pageY > window.innerHeight - 200
            ? "".concat(e1.pageY - 200, "px")
            : "".concat(e1.pageY, "px");
        var el_STRING = $08a7d5afccd80df8$export$adc6d72e517d4e6a(
          '<section class="'
            .concat(
              $93509171e9f96b5d$export$218b899e1d476006,
              '"\n        style="'
            )
            .concat(
              $069ff03ea42df4f6$export$bcbbd831497ce88.contextMenu(X, Y),
              '"  \n        data-type="contextmenu"\n        draggable="true"\n        >\n        <header>\n          <label>Guides</label>\n          <div class="'
            )
            .concat(
              $93509171e9f96b5d$export$b82da7a6a828be37,
              '"\n            data-action="close_context_menu">\n            <span class="'
            )
            .concat(
              $93509171e9f96b5d$export$bb646b20bb93d339,
              '"></span> \n            <span class="'
            )
            .concat(
              $93509171e9f96b5d$export$bb646b20bb93d339,
            ...
            .concat(
              $93509171e9f96b5d$export$545187d680fb3bce,
              '">\n          <div class="'
            )
            .concat(
              $93509171e9f96b5d$export$611455ef14a12093,
        ...
        var interactionElement = {
          ...
          change_position: el_STRING.querySelector(
            '[data-action="position_guides"]'
          ),
          ...
          items.forEach(function (item) {
            ...
            el_STRING.push(
              '<span\n            class="'
                ...
                .concat(item.direction, '"\n            data-offsetBy="')
                .concat(item.offsetBy, '"\n            data-count="')
                .concat(nbGuides++, '"\n            data-position="')
...
var $7759ad9a051faebd$export$191e63b17214d70d = /*#__PURE__*/ (function () {
  ...
  function $7759ad9a051faebd$export$191e63b17214d70d() {
    $iwYpZ$swchelpers.classCallCheck(
      this,
      $7759ad9a051faebd$export$191e63b17214d70d
    );
    this.currentStorage = [];
      ...
      value: function manage(target) {
        ...
        switch (target) {
          case "guides":
            ...
            var allGuides = this.UI_body.querySelectorAll(
              '[data-type="guides"]'
            );
            this.currentStorage = [];
...
var $8c4157cb11a74ad2$export$79bc953678f776f7 = /*#__PURE__*/ (function () {
  ...
  function $8c4157cb11a74ad2$export$79bc953678f776f7() {
    ...
    $iwYpZ$swchelpers.classCallCheck(
      this,
      $8c4157cb11a74ad2$export$79bc953678f776f7
    );
    this.ctrlKey = null;
    this.shiftKey = null;
    this.controlUser = {
    ...
    /** When keyControlas null , can't add guides */ document.addEventListener(
      "keyup",
      function (e) {
     ...
     */ document.addEventListener("mousedown", function (e) {
      ...
      if (
        ...
        _this2.switch_UI("show");
      _this2.ctrlKey = false;
      _this2.shiftKey = false;
    });
    document.addEventListener("mouseup", function (e) {});
    /** this event is only triggered when the user maintains
     *  the right click on a mark and performs a movement with the mouse */ document.addEventListener(
      "mousemove",
      $08a7d5afccd80df8$export$61fc7d43ac8f84b0(function (e) {
        e.preventDefault();
    ...
    this.UI_body.addEventListener("contextmenu", function (e1) {
      if (_this4.controlUser.hover) {
        ...
        _this4.interactiveElement.change_thickness.value =
          _this4.currentItem.dataset.height; //add event for interactive of contextMenu
        _this4.inputEl.value = _this4.currentItem.dataset.position;
        _this4.inputEl.focus();
        _this4.UI_body.querySelector(
          'label[for="position_guides"]'
        ).textContent =
          _this4.currentItem.dataset.direction === "X" ? "Y" : "X";
        ...
        _this4.interactiveElement.deleteBtn.addEventListener(
          "click",
          function (e) {
            _this6.deleteGuides();
          }
        );
        _this4.interactiveElement.change_thickness.addEventListener(
          "change",
          function (e) {
            _this7.changeThickness(e);
          }
        );
        _this4.interactiveElement.changeColor.addEventListener(
          "change",
          function (e) {
            _this8.changeColor_guides(e);
          }
        );
        _this4.interactiveElement.close_contextMenu.addEventListener(
          "click",
          function (e) {
  ...
  $iwYpZ$swchelpers.createClass($8c4157cb11a74ad2$export$79bc953678f776f7, [
    {
      ...
      value: function add_guides(e, direction) {
        if (direction === "X" || direction === "Y") {
          var elHtml = $08a7d5afccd80df8$export$adc6d72e517d4e6a(
      ...
      value: function addGuidesEvent(item) {
        ...
        item.addEventListener("mousedown", function (e) {
          ...
          if (_this11.showContextMenu) {
            _this11.interactiveElement.change_thickness.value =
              item.dataset.height;
            _this11.interactiveElement.change_position.value =
              item.dataset.position;
            _this11.UI_body.querySelector(
              'label[for="position_guides"]'
            ).textContent = item.dataset.direction === "X" ? "Y" : "X";
          }
        ...
        item.addEventListener("mouseout", function (e) {
          ...
          if (_this12.controlUser.grab && _this12.controlUser.move)
            _this12.controlUser.move = true;
    ...
    },
    {
      ...
      value: function injectGuidesInStorage() {
        if (localStorage.getItem("guides")) {
          ...
          var guidesCollection = this.create.deployStorage(
            this.currentStorage,
            this.currentColor
          );
          var injectEl = "";
          guidesCollection.forEach(function (item, key) {
            ...
            injectEl.style.background = _this14.makeGradient(
              injectEl.dataset.direction,
              _this14.currentColor,
              injectEl.dataset.height
            );
          });
          var currentIndex = guidesCollection.length - 1;
          this.currentItem = $08a7d5afccd80df8$export$adc6d72e517d4e6a(
            guidesCollection[currentIndex]
          );
      ...
      value: function deleteGuides() {
        ...
        if (!document.querySelectorAll('[data-type="guides"]').length) {
          ...
          if (this.showContextMenu) {
            this.showContextMenu = false;
            $08a7d5afccd80df8$export$84a19d80a0fc97e6(".contextMenu");
          }
    ...
    },
    {
      ...
      value: function changeThickness(e) {
        ...
        var newGradient = "linear-gradient(\n    to "
          ...
          .concat(this.currentColor, " ")
          .concat(parseInt(newVal) + 3, "px,\n    transparent ")
          .concat(parseInt(newVal) + 3, "px ,\n    transparent ")
          .concat(parseInt(newVal) + 5, "px)");
        this.currentItem.dataset.height = newVal;
        this.currentItem.style.background = newGradient;
        direction === "top"
          ? (this.currentItem.style.height = "".concat(
              parseInt(newThickness),
              "px"
            ))
          : (this.currentItem.style.width = "".concat(newThickness, "px"));
        this.manageStorage.manage("guides");
      },
    },
    {
      ...
      value: function changeColor_guides(e) {
        var _this = this,
          _this15 = this;
        var guidesCollection = document.querySelectorAll(
          '[data-type="guides"]'
        );
        this.currentColor = e.target.value;
        guidesCollection.forEach(function (item) {
          item.style.background = _this.makeGradient(
        ...
        terminals.forEach(function (item) {
          ...
          item.style[constructRules] = "8px solid ".concat(
            _this15.currentColor
          );
        });
      },
    },
