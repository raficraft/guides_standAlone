    ...
    $iwYpZ$swchelpers.createClass($1e812745baee1e97$export$69e780ca9f7a6d74, [
        {
            ...
            value: function get_guides(e, direction, color, thickness) {
                ...
                direction === "X" ? position = e.clientY : position = e.clientX;
                direction === "X" ? stylesSpan_Axis = $069ff03ea42df4f6$export$bcbbd831497ce88.span_axis_X(e.clientY, color, 1) : stylesSpan_Axis = $069ff03ea42df4f6$export$bcbbd831497ce88.span_axis_Y(e.clientX, color, 1);
        ...
        },
        {
            ...
            value: function get_contextMenu(e1) {
                ...
                var X = e1.clientX > window.innerWidth - 100 ? "".concat(e1.clientX - 150, "px") : "".concat(e1.clientX, "px");
                var Y = e1.clientY > window.innerHeight - 200 ? "".concat(e1.clientY - 200, "px") : "".concat(e1.clientY, "px");
     ...
     *  the right click on a mark and performs a movement with the mouse */ document.addEventListener("mousemove", $08a7d5afccd80df8$export$61fc7d43ac8f84b0(function(e) {
            ...
            if (_this3.controlUser.grab && _this3.controlUser.move) {
                if (_this3.currentItem.dataset.direction === "X") {
                    _this3.currentItem.style.top = e.clientY + "px";
                    _this3.currentItem.dataset.position = e.clientY;
                    if (_this3.showContextMenu) _this3.inputEl.value = e.clientY;
                } else if (_this3.currentItem.dataset.direction === "Y") {
                    _this3.currentItem.style.left = e.clientX + "px";
                    _this3.currentItem.dataset.position = e.clientX;
                    if (_this3.showContextMenu) _this3.inputEl.value = e.clientX;
                }
            }
        }), 300);
   ...
   */ key: "addGuidesEvent",
            value: function addGuidesEvent(item) {
                ...
                item.addEventListener("mousedown", function(e) {
                    ...
                    console.log("bug !!!", _this11.showContextMenu);
